...
- A selected `g` / `r` spawn shows its pack / set card docked in the bottom-left corner of the view (the same card as in 2D, kept off the terrain); click the card to fold it down to its title line and back, remembered in the workspace view settings.
