...
- The selected spawn of the Regen tab shows the same range handles as in 2D (edges and corners, standing on the ground): drag one to set Sx / Sy from the terrain point under the cursor, one undo step per drag.
